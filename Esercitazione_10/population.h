...
public:
    ...
    void selection(double expo);          // Applies selection based on a given exponential parameter
...
vector<int> rank_order(const vector<int>& vec); //Auxiliary function